...
module "master" {
  ...
  subnet_id          = "subnet-0347c9e6f3d831083" #module.vpc.public_subnet_ids[0]
...
module "worker_1" {
  ...
  ami                = "ami-020cba7c55df1f615" # us-east-1 Canonical, Ubuntu, 24.04, amd64 noble image
  instance_type      = "t3a.medium"
  subnet_id          = "subnet-0347c9e6f3d831083" #module.vpc.public_subnet_ids[1]
  vpc_id             = "vpc-02addb8eb7f41e597"    #module.vpc.vpc_id
  key_name           = aws_key_pair.generated_key.key_name # "devops-keypem-va"
  security_group_ids = aws_security_group.ec2_sg.id
...
module "worker_2" {
  ...
  ami                = "ami-020cba7c55df1f615" # us-east-1 Canonical, Ubuntu, 24.04, amd64 noble image
  instance_type      = "t3a.medium"
  subnet_id          = "subnet-0347c9e6f3d831083" #module.vpc.public_subnet_ids[2]
  vpc_id             = "vpc-02addb8eb7f41e597"    #module.vpc.vpc_id
  key_name           = aws_key_pair.generated_key.key_name # "devops-keypem-va"
  security_group_ids = aws_security_group.ec2_sg.id
